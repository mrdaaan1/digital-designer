...
- Продакшен: https://digital-designer-39i1.vercel.app
- render-service: https://digital-designer-render-service.onrender.com
- Полный пайплайн (загрузка шаблона → анализ дизайн-системы → генерация
  презентации по брифу → скачивание) проверен end-to-end на реальном .pptx
  в проде.
- Пользователи без своего шаблона могут выбрать один из готовых стилей
  ("Деловой синий", "Яркий / карточный") — витрина заполняется через
  `scripts/seed-public-templates.ts`.
